...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <link href="adminResources/css/themify-icons.css" rel="stylesheet">
    <link href="adminResources/css/owl.carousel.min.css" rel="stylesheet" />
    <link href="adminResources/css/owl.theme.default.min.css" rel="stylesheet" />
    <link href="adminResources/css/weather-icons.css" rel="stylesheet" />
    <link href="adminResources/css/sidebar.css" rel="stylesheet">
    <link href="adminResources/css/bootstrap.min.css" rel="stylesheet">
    <link href="adminResources/css/unix.css" rel="stylesheet">
...
<body>
   ...
   <jsp:include page="header.jsp"/>
                                    ...
                                    <div class="testimonial-widget-one owl-carousel owl-theme">
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <img class="testimonial-author-img" src="adminResources/images/1.jpg" alt="" />
                                ...
                                <div class="profile-widget-one">
                                    <div class="profile-one-user-photo">
                                        <div class="profile-one-bg">
                                            <img class="img-responsive" src="adminResources/images/profile-bg.jpg" alt="" />
    ...
    <!-- nano scroller -->
    <script src="adminResources/js/sidebar.js"></script>
    <script src="adminResources/js/pace.min.js"></script>
    <!-- sidebar -->
    <script src="adminResources/js/bootstrap.min.js"></script>
    <!-- bootstrap -->
    <script src="adminResources/js/jquery.simpleWeather.min.js"></script>
    <script src="adminResources/js/weather-init.js"></script>
    <script src="adminResources/js/circle-progress.min.js"></script>
    <script src="adminResources/js/circle-progress-init.js"></script>
    <script src="adminResources/js/chartist.min.js"></script>
    <script src="adminResources/js/chartist-init.js"></script>
    <script src="adminResources/js/jquery.sparkline.min.js"></script>
    <script src="adminResources/js/sparkline.init.js"></script>
    <script src="adminResources/js/owl.carousel.min.js"></script>
    <script src="adminResources/js/owl.carousel-init.js"></script>
